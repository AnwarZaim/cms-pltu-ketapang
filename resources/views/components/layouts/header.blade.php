        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{url('Dashboard')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ url('/') }}/admin-asset/assets/images/1.png" alt=""  style="width: 100px; height:70px;">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ url('/') }}/admin-asset/assets/images/1.png" alt="" style="width: 100px; height:70px;">
                    </span>
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ url('/') }}/admin-asset/assets/images/logo-sm-light.png" alt=""
                            height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ url('/') }}/admin-asset/assets/images/logo-light.png" alt=""
                            height="24">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="{{ url('/') }}/admin-asset/assets/images/users/avatar-4.jpg" alt="Header Avatar">
                </button>
