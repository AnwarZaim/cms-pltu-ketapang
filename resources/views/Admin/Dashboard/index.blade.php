                                    ...
                                    <div data-simplebar style="max-height: 334px;">
                                        <div class="inbox-wid">
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img
                                                            src="{{ url('/') }}/admin-asset/assets/images/users/avatar-1.jpg"
                                            ...
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img
                                                            src="{{ url('/') }}/admin-asset/assets/images/users/avatar-2.jpg"
                                                            class="avatar-md rounded-circle" alt=""></div>
                                            ...
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img
                                                            src="{{ url('/') }}/admin-asset/assets/images/users/avatar-3.jpg"
                                                            class="avatar-md rounded-circle" alt=""></div>
                                            ...
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img
                                                            src="{{ url('/') }}/admin-asset/assets/images/users/avatar-4.jpg"
                                                            class="avatar-md rounded-circle" alt=""></div>
                                            ...
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img
                                                            src="{{ url('/') }}/admin-asset/assets/images/users/avatar-5.jpg"
                                                            class="avatar-md rounded-circle" alt=""></div>
                                        ...
                                        <table class="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ url('/') }}/admin-asset/assets/images/users/avatar-2.jpg"
                                                                alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ url('/') }}/admin-asset/assets/images/users/avatar-3.jpg"
                                                                alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ url('/') }}/admin-asset/assets/images/users/avatar-4.jpg"
                                                                alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ url('/') }}/admin-asset/assets/images/users/avatar-5.jpg"
                                                                alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ url('/') }}/admin-asset/assets/images/users/avatar-6.jpg"
                                                                alt=""
                                        ...
                                        <table class="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ url('/') }}/admin-asset/assets/images/users/avatar-7.jpg"
                                                                alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ url('/') }}/admin-asset/assets/images/users/avatar-8.jpg"
                                                                alt=""
